...
const Info = () => {
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="devider w-full h-[1px] bg-gray-400/70 mt-2"></div>
      <div className="calander-info text-center px-6 mt-4 text-sm font-medium text-[#5c5c5e] text-opacity-90 ">
